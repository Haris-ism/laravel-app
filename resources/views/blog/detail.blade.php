<x-layout title="Loading... — The Blog" js="resources/js/pages/blog-detail.js">
    <x-slot:head>
    ...
    <div class="max-w-3xl mx-auto px-6 py-12">
        ...
        <!-- Error -->
        <div id="error" class="hidden bg-red-50 border border-red-100 rounded-2xl p-10 text-center">
        ...
        <article id="post" class="hidden">
            ...
            <!-- Back -->
            <a href="/blog" class="inline-flex items-center gap-2 text-sm text-gray-400 font-medium hover:text-gray-900 transition-colors mb-10">
                ← Back to articles
            </a>
            ...
            <div class="mb-10">
                <div class="flex items-center gap-3 mb-6">
                    <div id="post-avatar" class="w-10 h-10 rounded-full bg-gray-900 text-white flex items-center justify-center text-sm font-bold"></div>
                    <div>
                        <p class="text-sm font-semibold text-gray-900">Author</p>
                        <p id="post-date" class="text-xs text-gray-400"></p>
                    </div>
                </div>

                <h1 id="post-title" class="text-4xl font-extrabold text-gray-900 tracking-tight leading-tight mb-4"></h1>
            ...
            <!-- Content -->
            <div id="post-content" class="text-gray-600 text-lg leading-relaxed whitespace-pre-line"></div>
